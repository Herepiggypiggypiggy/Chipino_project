...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Fri Jan 14 14:13:34 CET 2022
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports MOSI]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports SCLK]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports SS]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports MISO]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports MOSI]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports SCLK]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports SS]
