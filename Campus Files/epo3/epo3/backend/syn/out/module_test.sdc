...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Fri Jan 14 16:19:49 CET 2022
...
set_load -pin_load 1.0 [get_ports MOSI]
set_load -pin_load 1.0 [get_ports SCLK]
set_load -pin_load 1.0 [get_ports SS]
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports MISO]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports button_left]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports button_right]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports button_up]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports button_down]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports button_mining]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports MOSI]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports SCLK]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports SS]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports MISO]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports button_left]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports button_right]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports button_up]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports button_down]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports button_mining]
